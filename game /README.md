...
Sur cette image, le jeu vient d'avoir été lancé. Le joueur, Mario (de la classe 'Player'), ainsi que ses adversaire, les Goomba (de la classe 'Monsteur') viennent d'apparaitre. Nous pouvons également le remarquer, car le score (inscrit en haut à gauche est
